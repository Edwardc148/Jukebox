...
StationSong.create(song_id: song3.id, station_id: station5.id)
...
StationSong.create(song_id: song4.id, station_id: station5.id)
...
StationSong.create(song_id: song1.id, station_id: station5.id)
